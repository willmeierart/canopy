import { CHECK_IF_MOBILE, CHECK_IF_IE, CHECK_BROWSER, GET_VP_DIMS, LOCK_ORIENTATION, IS_FRESH_LOAD } from './types'
...
export const checkIfMobile = () => async dispatch => {
	const bool = (window !== undefined && window.orientation !== undefined) || window.innerWidth < 700
	dispatch({
